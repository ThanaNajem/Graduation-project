...
if ($get_related_to_mother_msg_for_std!=null) {
 ...
 <div class="row" style="margin-bottom: 12px;">
 	...
 	<a href="sent_messages.php" class="btn btn-primary">الرجوع إلى الصفحة السابقة</a></center>
</div>
 </div>
<div class="row">
...
if ($get_arrachment_of_related_msg!=null) {
	 if ($get_arrachment_of_related_msg[0]['url_str']!="") {
		 ?>الملف المرفق: <a href="<?php echo $get_arrachment_of_related_msg[0]['url_str'] ; ?>" class="btn btn-primary">عرض الملف المرفق</a>  <br>    
