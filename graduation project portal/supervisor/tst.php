...
$output='';
	...
	var_dump($get_file_grp_gor_this_week);
...
<div class="col-md-8 col-md-offset-2">
  ...
  <!--div class="form-group"-->
   <br>
      <div class="radio">
      <label style="position:relative;right:16px;">قبول</label><input type="radio" style="margin: -17px 1px 0 !important; !important;" class="radio" name="status" required value="accepted">
    </div>
    <div class="radio">
