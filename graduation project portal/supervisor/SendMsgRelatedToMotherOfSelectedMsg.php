...
$selected_group1 = $_POST['groupOfUser'];
$sender = $_POST['sender'];  
$to_which_msg_id_reply=$_POST['motherMessageIDUseInWhichMsgReply'];
...
if(!file_exists ($dest_path)){      
    if( move_uploaded_file($file_tmp,$dest_path) ) {
      $row_count=0; 
//       //insert with file
      $row_count=Crud_op::insert_a_new_msg_with_its_attachment($selected_group1 ,$sender,$messages_text ,$to_which_msg_id_reply ,2 ,0,$dest_path,$FileStatus);
...
$url_str= $dest_path;
  ...
  //insert without file
  $insert_a_new_messages_without_attachment = Crud_op::insert_a_new_messages_without_attachment($selected_group1 ,$sender,$messages_text ,$to_which_msg_id_reply ,
  2 ,0);
...
<div class="row" style="margin-bottom: 12px;">
 ...
 <a href="follow_up_weekly_work_of_group_edit.php" class="btn btn-primary" style="margin-top:12px; ">الرجوع للصفحة الرئيسية</a>
    </div>  
</div>
</div>
<?php
