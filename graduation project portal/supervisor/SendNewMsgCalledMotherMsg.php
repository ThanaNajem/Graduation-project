...
<hr style="display: none;">
 <div class="form-group text-center">
    ...
    <div class="col-md-8 col-md-offset-2">
        <a class="btn icon-btn btn-primary" href="follow_up_weekly_work_of_group_edit.php"  
...
<hr style="display: none;">
 <div class="form-group text-center">
    <!-- <div class="col-sm-4"></div> -->
    <div class="col-md-8 col-md-offset-2">
        <a class="btn icon-btn btn-primary" href="NewMsgFromSupervisor.php?action=add"  
